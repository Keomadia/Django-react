...
function Form( {route,method}){
    ...
    return <>
        <form onSubmit={handleSubmit} action="" className="form-container">
            <h1>{heading}</h1>
            <input className="form-input" type="text" placeholder="Enter your Username" value={username} onChange={(e) => setUsername(e.target.value)}/>
            ...
            <button className="form-button" type="submit">{heading}</button>
        </form>
    </>
